CREATE DATABASE IF NOT EXISTS hlt_vkl_26 CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE hlt_vkl_26;
...
CREATE TABLE IF NOT EXISTS task (
    ...
    description TEXT NULL,
    version VARCHAR(50) NULL,
    max_concurrency_per_agent INT NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS scan_result_finding (
    ...
    evidence_file_mime_type VARCHAR(100) NULL,
    evidence_file_size INT NULL,
    confidence INT NULL,
