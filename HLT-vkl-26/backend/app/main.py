...
from app.services.agent_monitoring import AgentMonitorLoop
...
agent_monitor_loop = AgentMonitorLoop(settings.agent_monitor_poll_seconds)
...
def on_startup():
    ...
    if settings.agent_monitor_enabled:
        agent_monitor_loop.start()
