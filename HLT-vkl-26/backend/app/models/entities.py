...
class ScanResultFinding(Base, TimestampMixin):
    ...
    evidence_file_name: Mapped[str | None] = mapped_column(String(255), nullable=True)
    evidence_file_path: Mapped[str | None] = mapped_column(String(500), nullable=True)
    evidence_file_mime_type: Mapped[str | None] = mapped_column(String(100), nullable=True)
    evidence_file_size: Mapped[int | None] = mapped_column(Integer, nullable=True)
