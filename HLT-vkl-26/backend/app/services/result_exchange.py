        ...
        "findings": [
            {
                ...
                "poc_file_name": item.poc_file_name,
                "poc_file_path": item.poc_file_path,
                "poc_file_mime_type": item.poc_file_mime_type,
                "poc_file_size": item.poc_file_size,
...
def import_operation_results(db: Session, operation_id: int, payload_json: dict) -> tuple[OperationResultImportExport, int, int]:
    ...
    for item in findings_payload:
        scan_result_finding = ScanResultFinding(
            ...
            poc_file_name=item.get("poc_file_name"),
            poc_file_path=item.get("poc_file_path"),
            poc_file_mime_type=item.get("poc_file_mime_type"),
            poc_file_size=item.get("poc_file_size"),
