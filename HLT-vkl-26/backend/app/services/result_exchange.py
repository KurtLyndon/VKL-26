        ...
        "findings": [
            {
                ...
                "evidence_file_mime_type": item.evidence_file_mime_type,
                "evidence_file_size": item.evidence_file_size,
...
def import_operation_results(db: Session, operation_id: int, payload_json: dict) -> tuple[OperationResultImportExport, int, int]:
    ...
    for item in findings_payload:
        scan_result_finding = ScanResultFinding(
            ...
            note=item.get("note"),
            runtime_output=item.get("runtime_output") or item.get("evidence"),
            evidence_file_name=item.get("evidence_file_name") or item.get("poc_file_name"),
            evidence_file_path=item.get("evidence_file_path") or item.get("poc_file_path"),
            evidence_file_mime_type=item.get("evidence_file_mime_type") or item.get("poc_file_mime_type"),
            evidence_file_size=item.get("evidence_file_size") or item.get("poc_file_size"),
