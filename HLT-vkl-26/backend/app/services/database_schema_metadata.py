...
COLUMN_PURPOSES = {
    ...
    "poc_file_name": "Name of the CVE proof-of-concept script file.",
    "evidence_file_name": "Name of the evidence file attached to a finding.",
    "evidence_file_path": "Filesystem path of the finding evidence file.",
    "evidence_file_mime_type": "MIME type of the finding evidence file.",
    "evidence_file_size": "Evidence file size in bytes.",
    "evidence_text": "Verification note used as textual evidence for a CVE.",
    ...
    "runtime_output": "Runtime output captured from the scanning or verification tool.",
